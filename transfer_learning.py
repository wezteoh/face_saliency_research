...
class tl_face_classifier:
    ...
    def predict_graph(self):
        correct_prediction = tf.equal(tf.argmax(self.train_layers.fc3l_drop,1), tf.argmax(self.labels_1hot,1))
    ...
    def train(self, train_size, validation_size, batch_size, keep_prob, iter=300):        
        ...
        with tf.Session() as sess:
            ...
            np.save('fcl_weights_10faces_4.npy', best_weights) 
            f1 = plt.figure(1)
            ...
            f1.savefig("accuracies_tl_10faces_4.pdf", bbox_inches='tight')
            f2 = plt.figure(2)
            ...
            f2.savefig("costs_tl_10faces_4.pdf", bbox_inches='tight')
    ...
    def test(self):
        ...
        with tf.Session() as sess:
            self.load_weights('fcl_weights_10faces_4.npy', sess)
...
classifier1.train(70, 15, 80, 0.7, iter=1200)
